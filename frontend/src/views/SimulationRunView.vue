...
// Get maxRounds from query parameters during initialization to ensure child components can access it immediately
...
onMounted(() => {
  ...
  // Log maxRounds configuration (value retrieved from query parameters during initialization)
  if (maxRounds.value) {
