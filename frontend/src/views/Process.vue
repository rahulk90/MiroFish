<template>
  <div class="process-page">
    ...
    <div class="main-content">
      ...
      <div class="left-panel" :class="{ 'full-screen': isFullScreen }">
        ...
        <div class="graph-container" ref="graphContainer">
          ...
          <div v-else-if="currentPhase < 1" class="graph-waiting">
            ...
            <p class="waiting-hint">Graph construction will start automatically when generation is complete</p>
          </div>

          <!-- Construction in progress but no data yet -->
      ...
      <!-- Right Side: Construction Process Details -->
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">Description</div>
                <div class="detail-content">
                  Based on the generated ontology, the document is chunked and the Zep API is called to construct the knowledge graph and extract entities and relationships
                </div>
              </div>
...
const handleNewProject = async () => {
  ...
  if (!pending.isPending || pending.files.length === 0) {
    error.value = 'No pending files to upload, please return to home and try again'
    loading.value = false
    return
  }
...
const renderGraph = () => {
  ...
  // Close details panel on blank click
  svg.on('click', () => {
    closeDetailPanel()
  })
