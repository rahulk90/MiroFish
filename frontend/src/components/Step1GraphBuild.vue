    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Based on the generated ontology, the system chunks the document, calls Zep to build a knowledge graph, extracts entities and relationships, and creates temporal memory and community summaries
          </p>
