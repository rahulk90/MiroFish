...
class RetryableAPIClient:
    ...
    def call_batch_with_retry(
        ...
        """
        Batch call items with individual retry for each failure

        Args:
            items: List of items to process
            process_func: Processing function that takes a single item parameter
            exceptions: Exception types that trigger retry
            continue_on_failure: Whether to continue processing other items after one failure
